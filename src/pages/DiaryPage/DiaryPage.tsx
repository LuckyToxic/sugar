...
import { DiaryHeader } from "./ui/DiaryHeader.tsx/DiaryHeader";
...
export default function DiaryPage() {
  ...
  return (
    <div className="w-full relative h-screen-dynamic-minus-header flex flex-col bg-[#F8F8F8] p-4 max-w-md mx-auto overflow-y-auto hide-scrollbar">
      <DiaryHeader selectedDate={selectedDate} onDateChange={setSelectedDate} />
